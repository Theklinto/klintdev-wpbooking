...
class ScriptCollection {
	...
	public static function registerScriptCollection(): void {
		...
		wp_register_script( self::FORM_CONTROLLER, self::SCRIPT_FOLDER . "FormController.js", [
			self::JQUERY,
			self::ALERT
		], "1.0" );
		wp_register_script( self::OBJECT_PARSER, self::SCRIPT_FOLDER . "ObjectParser.js", [ self::JQUERY ], "1.0" );
